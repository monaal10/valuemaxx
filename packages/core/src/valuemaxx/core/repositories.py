...
class RunRepository(ABC):
    """Persistence for :class:`~valuemaxx.core.run.Run` records."""
...
class CostEventRepository(ABC):
    """Persistence for :class:`~valuemaxx.core.cost.CostEvent` records (M7 upsert)."""
...
class OutcomeEventRepository(ABC):
    """Persistence for :class:`~valuemaxx.core.outcome.OutcomeEvent` records."""
...
class ReconciliationRepository(ABC):
    """Append-only persistence for :class:`~valuemaxx.core.reconciliation.ReconciliationRecord`.
